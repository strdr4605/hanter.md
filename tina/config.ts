              ...
              { type: 'string', name: 'name', label: 'Brand name', required: true },
              {
                ...
                fields: [
                  { type: 'string', name: 'name', label: 'Model name', required: true },
                  {
                    ...
                    ui: { itemProps: (item) => ({ label: item.name }) },
                    fields: [
                      { type: 'string', name: 'name', label: 'Generation name', required: true },
                      {
                        type: 'object',
                        name: 'subgenerations',
                        label: 'Subgenerations (year ranges)',
                        list: true,
                        ui: { itemProps: (item) => ({ label: item.yearRange }) },
                        fields: [
                          { type: 'string', name: 'yearRange', label: 'Year range (e.g. 2005-2010)', required: true },
                          {
                            type: 'object',
                            name: 'options',
                            label: 'Seat options',
